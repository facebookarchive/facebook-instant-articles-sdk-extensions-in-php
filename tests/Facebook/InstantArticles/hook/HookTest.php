 ...
 */
namespace Facebook\InstantArticles\Hook;
...
class HookTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $hook = Hook::create();
        $result = $hook->call('hook_name', array('Facebook\InstantArticles\hook\HookTest', 'staticMethodHook'));
    ...
    {
        $hook = Hook::create();
        $result = $hook->call('hook_name', 'Facebook\InstantArticles\hook\functionOutsideClass');
    ...
    {
        $hook = Hook::create();
        $result = $hook->call('hook_name', 'Facebook\InstantArticles\hook\functionOutsideClassWithParams', array('param1'));
